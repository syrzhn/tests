 ...
 * for details.
 */
public class GwtTestFirstProject extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "ru.klinichev.firstproject.FirstProjectJUnit";
  }
  ...
  /* public void testGreetingService() {
    ...
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "FirstProject/greet");
