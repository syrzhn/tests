...
CREATE TABLE IF NOT EXISTS "contracts" (
	...
	FOREIGN KEY("person_id") REFERENCES "persons"("person_id") ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO "realty_factors" ("realty_factor_id","name","multiplier") VALUES (1,'Квартира',1.7),
 (2,'Дом',1.5),
 (3,'Комната',1.3);
INSERT INTO "contracts" ("contract_id","tender","create_date","actual_date","prize","realty_factor_id","old_year","square","calculate_date","person_id","adress_id","comment") VALUES (1,2000.0,'2018-12-03','2019-03-30',783.0,1,9,49,'2018-12-03',1,1,'comments1'),
...
CREATE VIEW contracts_table_view AS SELECT
 ...
 FROM contracts
 INNER JOIN persons ON persons.person_id = contracts.person_id;
